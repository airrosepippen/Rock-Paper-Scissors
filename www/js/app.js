...
lab2.factory('processMove', function() {
  return function() {
    self.checkWins =  function(player1_choice, player2_choice) {
      ...
      /* Players select the same thing, it's a tie: */
      if(self.getChoiceAsNumber(a) == self.getChoiceAsNumber(b)){
        return 0;
      }
      ...
      else if(self.getChoiceAsNumber(a) == 2 && self.getChoiceAsNumber(b) == 1) {
        return 1;
      }
      // P1: PAPER, P2: ROCK
      else if(self.getChoiceAsNumber(a) == 1 && self.getChoiceAsNumber(b) == 0) {
        return 1;
      }
      // P1: ROCK, P2: SCISSORS:
      else if(self.getChoiceAsNumber(a) == 0 && self.getChoiceAsNumber(b) == 2) {
        return 1;
      }
...
lab2.controller('player2', function(processMove, $rootScope, $scope, $ionicModal, $ionicLoading, $ionicViewSwitcher, $state, $stateParams, navigation) {
  ...
  $scope.onNext = function (choice) {
    ...
    } else if($scope.processMove.checkWins($stateParams.player1_choice, choice) == 2) {
